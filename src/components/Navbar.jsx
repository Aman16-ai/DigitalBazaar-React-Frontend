...
export default function () {
  ...
  return (
    <div className={style["container"]}>
      ...
      />
      {!isAuthenticated ? (
        <button onClick={handleOpenLoginModal} id={style["logoutBtn"]}>
          Login
        </button>
      ) : (
            ...
            <ul>
              <li>
                <Link
                  ...
                  to={"/myorders"}
                >
                  <img className={style["drop-down-icons"]} src={ordericon} />
                  Orders
                </Link>
              </li>
              ...
              <li onClick={handleLogout}>
                <img
                  className={style["drop-down-icons"]}
                  src={logouticon}
                  alt=""
                />
                Logout
      ...
      <Link className={style["links"]}>
        <img className={style["nav-icons"]} src={notificationIcon} alt="" />
        Notification
      </Link>
      <Link to={"/cart"} className={style["links"]}>
        <img className={style["nav-icons"]} src={cartIcon} alt="" />
        Cart ({user_cart?.getCartTotalItems ? user_cart?.getCartTotalItems : 0})
      </Link>
    </div>
  );
}
